# CODE SNAPSHOT v:2026391AUT2251580434
...
📦 Zeskanowano fizycznie: 1930 plików, 371 katalogów
```

## Structure

```plaintext
  ▣─┬ tisdb                             [473.3 KiB]                      A:/A-JAN/WIN-DOCS/REPO_OWN_RUST/GIT 
    │                                                                    _tisdb/tisdb/                       
 ...
 2  │  ├──• CONCEPT.md                  [ 15.1 KiB] [2026-38-6 06:27:36] ./docs/CONCEPT.md                   
    ...
    ├──┬ src                            [ 30.8 KiB] [2026-38-5 20:14:42] ./src/                              
 3  │  ├──• engine.rs                   [ 13.0 KiB] [2026-39-1 22:48:22] ./src/engine.rs                     
...
impl<S: StorageBackend> CisowskiEngine<S> {
    ...
    pub fn load(&mut self) -> Result<(), CoreError> {
        ...
        // Standard rkyv::util::AlignedVec implementuje Default bez generyka ALIGNMENT dla domyślnego wyrównania.
        // Używamy bezpiecznej wersji nieparametryzowanej, w pełni kompatybilnej.
        let mut archive_bytes = AlignedVec::new();
