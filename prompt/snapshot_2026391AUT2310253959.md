# CODE SNAPSHOT v:2026391AUT2310253959
...
📦 Zeskanowano fizycznie: 2093 plików, 371 katalogów
```

## Structure

```plaintext
  ▣─┬ tisdb                             [474.2 KiB]                      A:/A-JAN/WIN-DOCS/REPO_OWN_RUST/GIT 
    │                                                                    _tisdb/tisdb/                       
 ...
 2  │  ├──• CONCEPT.md                  [ 15.1 KiB] [2026-38-6 06:27:36] ./docs/CONCEPT.md                   
    ...
    ├──┬ src                            [ 31.7 KiB] [2026-38-5 20:14:42] ./src/                              
 3  │  ├──• engine.rs                   [ 12.8 KiB] [2026-39-1 23:08:51] ./src/engine.rs                     
...
11  │  │  └──• zone.rs                  [  1.5 KiB] [2026-39-1 21:53:46] ./src/domain/zone.rs                
    │  └──┬ storage                     [  5.4 KiB] [2026-38-5 20:14:42] ./src/storage/                      
12  │     ├──• backend.rs               [    610 B] [2026-39-1 23:07:07] ./src/storage/backend.rs            
13  │     ├──• file.rs                  [  3.7 KiB] [2026-39-1 23:07:44] ./src/storage/file.rs               
14  │     └──• memory.rs                [  1.1 KiB] [2026-39-1 23:08:08] ./src/storage/memory.rs             
