# CODE SNAPSHOT v:2026391AUT2236263737
...
📦 Zeskanowano fizycznie: 1925 plików, 371 katalogów
```

## Structure

```plaintext
  ▣─┬ tisdb                             [469.3 KiB]                      A:/A-JAN/WIN-DOCS/REPO_OWN_RUST/GIT 
    │                                                                    _tisdb/tisdb/                       
 ...
 2  │  ├──• CONCEPT.md                  [ 15.1 KiB] [2026-38-6 06:27:36] ./docs/CONCEPT.md                   
    ...
    ├──┬ src                            [ 30.5 KiB] [2026-38-5 20:14:42] ./src/                              
 3  │  ├──• engine.rs                   [ 12.8 KiB] [2026-39-1 22:35:44] ./src/engine.rs                     
 ...
 9  │  │  ├──• metadata.rs              [  3.6 KiB] [2026-39-1 22:32:05] ./src/domain/metadata.rs            
...
pub struct EntityHeader {
    ...
    // 3. Właściwości Dynamiczne - POWRÓT DO HashMap (rkyv obsługuje go poprawnie przy AlignedVec)
...
impl<S: StorageBackend> CisowskiEngine<S> {
    ...
    pub fn load(&mut self) -> Result<(), CoreError> {
        ...
        // ZMIANA: Dodano jawną stałą <16> definiującą Alignment pamięci dla nowej wersji rkyv
        let mut archive_bytes: AlignedVec<16> = AlignedVec::with_capacity(file_bytes.len() - 4);
