# CODE SNAPSHOT v:2026391AUT1932251806
...
📦 Zeskanowano fizycznie: 1349 plików, 370 katalogów
```

## Structure

```plaintext
  ▣─┬ tisdb                             [458.1 KiB]                      A:/A-JAN/WIN-DOCS/REPO_OWN_RUST/GIT 
    │                                                                    _tisdb/tisdb/                       
 1  ├──• Cargo.toml                     [    389 B] [2026-38-5 20:12:51] ./Cargo.toml                        
 ...
 2  │  ├──• CONCEPT.md                  [ 15.1 KiB] [2026-38-6 06:27:36] ./docs/CONCEPT.md                   
    ...
    ├──┬ src                            [ 20.6 KiB] [2026-38-5 20:14:42] ./src/                              
 3  │  ├──• engine.rs                   [  8.3 KiB] [2026-37-3 19:14:54] ./src/engine.rs                     
 4  │  ├──• error.rs                    [    852 B] [2026-37-3 10:02:23] ./src/error.rs                      
 5  │  ├──• lib.rs                      [    669 B] [2026-38-5 20:14:24] ./src/lib.rs                        
    │  ├──┬ domain                      [  6.9 KiB] [2026-38-5 20:14:42] ./src/domain/                       
 6  │  │  ├──• flow.rs                  [  1.6 KiB] [2026-37-3 10:03:35] ./src/domain/flow.rs                
 7  │  │  ├──• hyper.rs                 [  1.3 KiB] [2026-37-3 10:04:37] ./src/domain/hyper.rs               
 8  │  │  ├──• id.rs                    [  1.9 KiB] [2026-37-3 13:41:25] ./src/domain/id.rs                  
 9  │  │  ├──• node.rs                  [    693 B] [2026-37-3 10:04:16] ./src/domain/node.rs                
10  │  │  └──• zone.rs                  [  1.4 KiB] [2026-37-3 10:03:52] ./src/domain/zone.rs                
    │  └──┬ storage                     [  3.9 KiB] [2026-38-5 20:14:42] ./src/storage/                      
11  │     ├──• backend.rs               [    415 B] [2026-37-3 13:42:24] ./src/storage/backend.rs            
12  │     ├──• file.rs                  [  2.2 KiB] [2026-37-3 19:09:32] ./src/storage/file.rs               
13  │     └──• memory.rs                [  1.2 KiB] [2026-37-3 18:52:30] ./src/storage/memory.rs             
    └──┬ tests                          [  4.3 KiB] [2026-38-5 20:16:09] ./tests/                            
14     ├──• axiom_tests.rs              [  2.0 KiB] [2026-38-5 20:34:43] ./tests/axiom_tests.rs              
15     ├──• persistence_tests.rs        [  1.4 KiB] [2026-38-5 20:34:43] ./tests/persistence_tests.rs        
16     └──• storage_tests.rs            [    833 B] [2026-38-5 20:34:43] ./tests/storage_tests.rs            
```
